    ...
    meals: [
      {
        ...
        description: 'Monday breakfast — warm oats with dairy milk and fresh berries',
        image: weightLossImages.oats,
        calories: 280,
        protein: 10,
        carbs: 42,
      ...
      {
        id: 'kd-m2',
        name: 'Paneer & Veggie Loaded Poha',
        description: 'Wednesday breakfast — light flattened rice with mild spices and paneer cubes',
        image: pregnancyImages.poha,
        calories: 320,
        protein: 12,
        carbs: 45,
      ...
      {
        id: 'kd-m3',
        name: 'Dal Khichdi & Salad',
        description: 'Monday lunch — soothing dal and rice mix, easy to digest and highly nutritious',
        image: weightLossImages.dal,
        calories: 360,
        protein: 14,
        carbs: 52,
      ...
      {
        id: 'kd-m4',
        name: 'Healthy Veggie Soup & Sautéed Paneer',
        description: 'Monday dinner — warm, creamy vegetable soup served with soft paneer',
        image: weightLossImages.moong,
        calories: 290,
        protein: 16,
        carbs: 28,
      ...
      {
        id: 'kd-m5',
        name: 'Creamy Chia Yogurt Pudding',
        description: 'Friday breakfast — delicious yogurt with soaked chia seeds, raw honey and fresh fruits',
        image: pregnancyImages.chiaPudding,
        calories: 270,
        protein: 10,
        carbs: 34,
